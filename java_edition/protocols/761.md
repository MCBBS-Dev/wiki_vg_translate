...
#### Set Action Bar Text {#set_action_bar_text}
  ...
  Packet ID   State   Bound To   Field Name        Field Type                Notes
  ----------- ------- ---------- ----------------- ------------------------- ------------------------------------------------------------------------------------------------------------------------
  0x42        Play    Client     Action bar text   [Chat](Chat "wikilink")   Displays a message above the hotbar (the same as position 2 in [Player Chat Message](#Player_Chat_Message "wikilink").

#### Set Border Center {#set_border_center}

  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ -------
  0x43        Play    Client     X            Double       
                                 Z            Double       
...
#### Set Border Lerp Size {#set_border_lerp_size}
  ...
  Packet ID   State   Bound To   Field Name     Field Type   Notes
  ----------- ------- ---------- -------------- ------------ ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  0x44        Play    Client     Old Diameter   Double       Current length of a single side of the world border, in meters.
                                 New Diameter   Double       Target length of a single side of the world border, in meters.
                                 Speed          VarLong      Number of real-time *milli*seconds until New Diameter is reached. It appears that Notchian server does not sync world border speed to game ticks, so it gets out of sync with server lag. If the world border is not moving, this is set to 0.
...
#### Set Border Size {#set_border_size}
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ ---------------------------------------------------------
  0x45        Play    Client     Diameter     Double       Length of a single side of the world border, in meters.

#### Set Border Warning Delay {#set_border_warning_delay}

  Packet ID   State   Bound To   Field Name     Field Type   Notes
  ----------- ------- ---------- -------------- ------------ ---------------------------------------------------
  0x46        Play    Client     Warning Time   VarInt       In seconds as set by `/worldborder warning time`.

#### Set Border Warning Distance {#set_border_warning_distance}

  Packet ID   State   Bound To   Field Name       Field Type   Notes
  ----------- ------- ---------- ---------------- ------------ ------------
  0x47        Play    Client     Warning Blocks   VarInt       In meters.
...
spectating an entity).
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ --------------------------------------------------
  0x48        Play    Client     Camera ID    VarInt       ID of the entity to set the client\'s camera to.
...
Sent to change the player\'s slot selection.
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ ------------------------------------------------
  0x49        Play    Client     Slot         Byte         The slot which the player has selected (0--8).
...
even if it doesn\'t go across a chunk section border.
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ -----------------------------------------------
  0x4A        Play    Client     Chunk X      VarInt       Chunk X coordinate of the player\'s position.
...
the overworld after leaving the end.
  ...
  Packet ID   State   Bound To   Field Name      Field Type   Notes
  ----------- ------- ---------- --------------- ------------ -------------------------
  0x4B        Play    Client     View Distance   VarInt       Render distance (2-32).
...
to). It can be sent at any time to update the point compasses point at.
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ -----------------------------------
  0x4C        Play    Client     Location     Position     Spawn location.
...
This is sent to the client when it should display a scoreboard.
  ...
  Packet ID   State   Bound To   Field Name   Field Type    Notes
  ----------- ------- ---------- ------------ ------------- -------------------------------------------------------------------------------------------------------------------------------
  0x4D        Play    Client     Position     Byte          The position of the scoreboard. 0: list, 1: sidebar, 2: below name, 3 - 18: team specific sidebar, indexed as 3 + team color.
...
`{{Minecraft Wiki|Lead|leashed}}`{=mediawiki} to another entity.
  ...
  Packet ID   State   Bound To   Field Name           Field Type   Notes
  ----------- ------- ---------- -------------------- ------------ ---------------------------------------------------------
  0x4F        Play    Client     Attached Entity ID   Int          Attached entity\'s EID.
...
#### Set Equipment {#set_equipment}
  ...
  Packet ID   State   Bound To   Field Name          Field Type
  ----------- ------- ---------- ------------ ------ ------------
  0x51        Play    Client     Entity ID           VarInt
...
Sent by the server when the client should change experience levels.
  ...
  Packet ID   State   Bound To   Field Name         Field Type   Notes
  ----------- ------- ---------- ------------------ ------------ -----------------------------------------------------------------------------------------------------------------------------
  0x52        Play    Client     Experience bar     Float        Between 0 and 1.
...
saturation as well as the food bar.
  ...
  Packet ID   State   Bound To   Field Name        Field Type   Notes
  ----------- ------- ---------- ----------------- ------------ ------------------------------------------------------
  0x53        Play    Client     Health            Float        0 or less = dead, 20 = full HP.
                                 Food              VarInt       0--20.
...
`{{Minecraft Wiki|scoreboard}}`{=mediawiki} objective or remove one.
  ...
  Packet ID   State   Bound To   Field Name        Field Type             Notes
  ----------- ------- ---------- ----------------- ---------------------- ---------------------------------------------------------------------------------------
  0x54        Play    Client     Objective Name    String (16)            A unique name for the objective.
...
#### Set Passengers {#set_passengers}
  ...
  Packet ID   State   Bound To   Field Name        Field Type        Notes
  ----------- ------- ---------- ----------------- ----------------- --------------------------------------------
  0x55        Play    Client     Entity ID         VarInt            Vehicle\'s EID.
...
Creates and updates teams.
  ...
  Packet ID   State   Bound To   Field Name                                           Field Type
  ----------- ------- ---------- ------------------------------ --------------------- ----------------------
  0x56        Play    Client     Team Name                                            String (16)
                                 Mode                                                 Byte
...
This is sent to the client when it should update a scoreboard item.
  ...
  Packet ID   State   Bound To   Field Name       Field Type        Notes
  ----------- ------- ---------- ---------------- ----------------- ------------------------------------------------------------------------------------------------------------
  0x57        Play    Client     Entity Name      String (40)       The entity whose score this is. For players, this is their username; for other entities, it is their UUID.
...
#### Set Simulation Distance {#set_simulation_distance}
  ...
  Packet ID   State   Bound To   Field Name            Field Type   Notes
  ----------- ------- ---------- --------------------- ------------ ------------------------------------------------------------------------------
  0x58        Play    Client     Simulation Distance   VarInt       The distance that the client will process specific things, such as entities.

#### Set Subtitle Text {#set_subtitle_text}

  Packet ID   State   Bound To   Field Name      Field Type                Notes
  ----------- ------- ---------- --------------- ------------------------- -------
  0x59        Play    Client     Subtitle Text   [Chat](Chat "wikilink")   
...
The default SMP server increments the time by `20` every second.
  ...
  Packet ID   State   Bound To   Field Name    Field Type   Notes
  ----------- ------- ---------- ------------- ------------ ---------------------------------------------------------------------------------------------------------
  0x5A        Play    Client     World Age     Long         In ticks; not changed by server commands.
...
#### Set Title Text {#set_title_text}
  ...
  Packet ID   State   Bound To   Field Name   Field Type                Notes
  ----------- ------- ---------- ------------ ------------------------- -------
  0x5B        Play    Client     Title Text   [Chat](Chat "wikilink")   

#### Set Title Animation Times {#set_title_animation_times}

  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ ----------------------------------------------------------
  0x5C        Play    Client     Fade In      Int          Ticks to spend fading in.
...
[here](https://pokechu22.github.io/Burger/1.19.3.html#sounds).
...
```
  Packet ID   State   Bound To   Field Name        Field Type            Notes
  ----------- ------- ---------- ----------------- --------------------- --------------------------------------------------------------------------------------------------------------------------------
  0x5D        Play    Client     Sound ID          VarInt                Represents the `Sound ID + 1`. If the value is 0, the packet contains a sound specified by Identifier.
...
```
  Packet ID   State   Bound To   Field Name          Field Type            Notes
  ----------- ------- ---------- ------------------- --------------------- -----------------------------------------------------------------------------------------------------------------------------------------------
  0x5E        Play    Client     Sound ID            VarInt                Represents the `Sound ID + 1`. If the value is 0, the packet contains a sound specified by Identifier.
                                 Sound Name          Optional Identifier   Only present if Sound ID is 0
                                 Has Fixed Range     Optional Boolean      Only present if Sound ID is 0.
                                 Range               Optional Float        The fixed range of the sound. Only present if previous boolean is true and Sound ID is 0.
                                 Sound Category      VarInt Enum           The category that this sound will be played from ([current categories](https://gist.github.com/konwboj/7c0c380d3923443e9d55)).
...
#### Stop Sound {#stop_sound}
  ...
  Packet ID   State   Bound To   Field Name   Field Type             Notes
  ----------- ------- ---------- ------------ ---------------------- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
  0x5F        Play    Client     Flags        Byte                   Controls which fields are present.
...
positions.
  ...
  Packet ID   State   Bound To   Field Name   Field Type                Notes
  ----------- ------- ---------- ------------ ------------------------- ------------------------------------------------------
  0x60        Play    Client     Content      [Chat](Chat "wikilink")   Limited to 262144 bytes.
...
Notchian server.
  ...
  Packet ID   State   Bound To   Field Name   Field Type                Notes
  ----------- ------- ---------- ------------ ------------------------- -------------------------------------------------------------------
  0x61        Play    Client     Header       [Chat](Chat "wikilink")   To remove the header, send a empty text component: `{"text":""}`.
...
Tag](#Query_Entity_Tag "wikilink").
  ...
  Packet ID   State   Bound To   Field Name       Field Type                  Notes
  ----------- ------- ---------- ---------------- --------------------------- ---------------------------------------------------------------------------------------
  0x62        Play    Client     Transaction ID   VarInt                      Can be compared to the one sent in the original query packet.
...
different varieties of arrows.
  ...
  Packet ID   State   Bound To   Field Name            Field Type   Notes
  ----------- ------- ---------- --------------------- ------------ ------------------------------------------------------------------------
  0x63        Play    Client     Collected Entity ID   VarInt       
...
#### Update Advancements {#update_advancements}
  ...
  Packet ID   State   Bound To   Field Name                    Field Type
  ----------- ------- ---------- --------------------- ------- ---------------------
  0x65        Play    Client     Reset/Clear                   Boolean
                                 Mapping size                  VarInt
...
client.
  ...
  Packet ID   State   Bound To   Field Name       Field Type         Notes
  ----------- ------- ---------- ---------------- ------------------ ----------------------------------------------------
  0x67        Play    Client     Total Features   VarInt             Number of features that appear in the array below.
...
#### Update Recipes {#update_recipes}
  ...
  Packet ID   State   Bound To   Field Name                Field Type
  ----------- ------- ---------- ------------- ----------- ------------
  0x69        Play    Client     Num Recipes               VarInt
                                 Recipe        Type        Array
                                               Recipe ID   
                                               Data        
...
#### Update Tags {#update_tags}
  ...
  Packet ID   State   Bound To   Field Name                           Field Type
  ----------- ------- ---------- --------------------- -------------- ------------
  0x6A        Play    Client     Length of the array                  VarInt
...
enchantment tables.
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ ----------------------------------------------------------------------
  0x09        Play    Server     Window ID    Byte         The ID of the window sent by [Open Screen](#Open_Screen "wikilink").
...
window.
  ...
  Packet ID   State   Bound To   Field Name                          Field Type
  ----------- ------- ---------- --------------------- ------------- ------------------------------
  0x0A        Play    Server     Window ID                           Unsigned Byte
                                 State ID                            VarInt
                                 Slot                                Short
                                 Button                              Byte
                                 Mode                                VarInt Enum
...
the packet has no length field of any kind.
  ...
  Packet ID   State   Bound To   Field Name   Field Type           Notes
  ----------- ------- ---------- ------------ -------------------- -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  0x0C        Play    Server     Channel      Identifier           Name of the [plugin channel](plugin_channel "wikilink") used to send the data.
...
functionality (middle click) to retrieve items from the inventory.
  ...
  Packet ID   State   Bound To   Field Name    Field Type   Notes
  ----------- ------- ---------- ------------- ------------ ----------------------------------------
  0x19        Play    Server     Slot to use   VarInt       See [Inventory](Inventory "wikilink").
...
#### Player Session {#player_session}
  ...
  Packet ID   State   Bound To   Field Name                          Field Type
  ----------- ------- ---------- ------------ ---------------------- ------------
  0x20        Play    Server     Session Id                          UUID
