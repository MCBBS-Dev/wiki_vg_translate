...
This causes the server to switch into the target state.
  ...
  ----------- ------------- ---------- ------------------ ---------------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  0x00        Handshaking   Server     Protocol Version   VarInt           See [protocol version numbers](protocol_version_numbers "wikilink") (currently 760 in Minecraft 1.19.2).
...
#### Chat Suggestions {#chat_suggestions}
  ...
  Packet ID   State   Bound To   Field Name   Field Type        Notes
  ----------- ------- ---------- ------------ ----------------- --------------------------------------------
  0x15        Play    Client     Action       VarInt            0: Add, 1: Remove, 2: Set
                                 Count        VarInt            Number of elements in the following array.
...
[here](plugin_channel "wikilink").
  ...
  Packet ID   State   Bound To   Field Name   Field Type             Notes
  ----------- ------- ---------- ------------ ---------------------- --------------------------------------------------------------------------------
  0x16        Play    Client     Channel      Identifier             Name of the [plugin channel](plugin_channel "wikilink") used to send the data.
...
resource packs.
  ...
  Packet ID   State   Bound To   Field Name          Field Type    Notes
  ----------- ------- ---------- ------------------- ------------- -----------------------------------------------------------------------------------------------------------------------------------------------
  0x17        Play    Client     Sound Name          Identifier    All sound effect names can be seen [here](https://pokechu22.github.io/Burger/1.19.html#sounds).
...
#### Hide Message {#hide_message}
  ...
  Packet ID   State   Bound To   Field Name         Field Type   Notes
  ----------- ------- ---------- ------------------ ------------ -------------------------
  0x18        Play    Client     Signature Length   VarInt       Length of Signature.
...
gamemode to demo messages.
  ...
  Packet ID   State   Bound To   Field Name   Field Type      Notes
  ----------- ------- ---------- ------------ --------------- --------------------
  0x1D        Play    Client     Event        Unsigned Byte   See below.
...
horse-like animal.
  ...
  Packet ID   State   Bound To   Field Name   Field Type      Notes
  ----------- ------- ---------- ------------ --------------- -------
  0x1E        Play    Client     Window ID    Unsigned Byte   
                                 Slot count   VarInt          
                                 Entity ID    Integer         
...
it is ignored on other effects.
  ...
  Packet ID   State   Bound To   Field Name                Field Type   Notes
  ----------- ------- ---------- ------------------------- ------------ -------------------------------------------
  0x22        Play    Client     Event                     Int          The event, see below.
...
Displays the named particle
  ...
  Packet ID   State   Bound To   Field Name       Field Type   Notes
  ----------- ------- ---------- ---------------- ------------ ------------------------------------------------------------------------------------
  0x23        Play    Client     Particle ID      VarInt       The particle ID listed in [the particle data type](#Particle "wikilink").
...
#### Message Header {#message_header}
  ...
  Packet ID   State   Bound To   Field Name                Field Type            Notes
  ----------- ------- ---------- ------------------------- --------------------- --------------------------------------------------
  0x32        Play    Client     Has Preceding Signature   Boolean               
                                 Preceding Signature       Optional Byte Array   Only present if Has Preceding Signature is true.
                                 Sender                    UUID                  
...
those that are unknown
  ...
  ----------- ------- ---------- ------------------- ----------------------------- ----------------------------------- ----------------------------------
  0x33        Play    Client     Header              Message Signature Present                                         boolean
                                                     Message Signature length                                          Optional VarInt
                                                     Message Signature bytes                                           Optional Byte Array
                                                     Sender                                                            UUID
                                                     Header signature length                                           VarInt
                                                     Header signature bytes                                            Byte Array
                                                     Plain Message                                                     String (max length of 256)
                                                     Formatted message present                                         boolean
                                                     Formatted Message                                                 [Chat](Chat "wikilink")
                                                     Timestamp                                                         long
                                                     Salt                                                              long
                                 Previous messages   Previous message length                                           VarInt
                                                     Array (Max size of 5)                                             
                                                                                   Previous message sender             UUID
                                                                                   Previous message signature length   VarInt
                                                                                   Previous message signature bytes    ByteArray
                                 Body                Unsigned Content Present                                          boolean
                                                     Unsigned Content                                                  Optional [Chat](Chat "wikilink")
                                                     Filter Type                                                       ENUM VarInt
                                                     Filter Type mask length                                           Optional VarInt
                                                     Filter Type bytes                                                 Optional BitSet
                                 Network target      Chat Type                                                         VarInt
                                                     Network name                                                      [Chat](Chat "wikilink")
                                                     Network target name present                                       boolean
                                                     Network target name                                               Optional [Chat](Chat "wikilink")
...
metadata circa 1.8.f
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ ------------------------------------------------------------------------------------------------
  0x34        Play    Client     Duration     VarInt       Length of the combat in ticks.
...
Used to send a respawn screen.
  ...
  Packet ID   State   Bound To   Field Name   Field Type                Notes
  ----------- ------- ---------- ------------ ------------------------- ---------------------------------------------------------------------------
  0x36        Play    Client     Player ID    VarInt                    Entity ID of the player that died (should match the client\'s entity ID).
...
looking straight up, and 90 is looking straight down.
  ...
  Packet ID   State   Bound To   Field Name         Field Type   Notes
  ----------- ------- ---------- ------------------ ------------ ------------------------------------------------------------------------------------------------------------------------------------
  0x39        Play    Client     X                  Double       Absolute or relative position, depending on Flags.
...
Sent by the server when an entity is to be destroyed on the client.
  ...
  Packet ID   State   Bound To   Field Name   Field Type        Notes
  ----------- ------- ---------- ------------ ----------------- --------------------------------------------
  0x3B        Play    Client     Count        VarInt            Number of elements in the following array.
...
| ID       |       |          | Name     | Type     |          |
+==========+=======+==========+==========+==========+==========+
| 0x3D     | Play  | Client   | URL      | String   | The URL  |
|          |       |          |          | (32767)  | to the   |
|          |       |          |          |          | resource |
|          |       |          |          |          | pack.    |
+----------+-------+----------+----------+----------+----------+
...
automatically.
  ...
  Packet ID   State   Bound To   Field Name             Field Type      Notes
  ----------- ------- ---------- ---------------------- --------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  0x3E        Play    Client     Dimension Type         Identifier      Valid dimensions are defined per dimension registry sent in [Login (play)](#Login_(play) "wikilink")
                                 Dimension Name         Identifier      Name of the dimension being spawned into.
                                 Hashed seed            Long            First 8 bytes of the SHA-256 hash of the world\'s seed. Used client side for biome noise
                                 Gamemode               Unsigned Byte   0: survival, 1: creative, 2: adventure, 3: spectator. The hardcore flag is not included
                                 Previous Gamemode      Byte            -1: null 0: survival, 1: creative, 2: adventure, 3: spectator. The hardcore flag is not included. The previous gamemode. (More information needed)
                                 Is Debug               Boolean         True if the world is a `{{Minecraft Wiki|debug mode}}`{=mediawiki} world; debug mode worlds cannot be modified and have predefined blocks.
                                 Is Flat                Boolean         True if the world is a `{{Minecraft Wiki|superflat}}`{=mediawiki} world; flat worlds have different void fog and a horizon at y=0 instead of y=63.
...
```
  Packet ID   State   Bound To   Field Name               Field Type         Notes
  ----------- ------- ---------- ------------------------ ------------------ ----------------------------------------------------------------------------------------------------------------------------------------------------------------------
  0x40        Play    Client     Chunk section position   Long               Chunk section coordinate (encoded chunk x and z with each 22 bits, and section y with 20 bits, from left to right).
...
advancement in another tab is made.
  ...
  Packet ID   State   Bound To   Field Name            Field Type       Notes
  ----------- ------- ---------- --------------------- ---------------- -----------------------------------------
  0x41        Play    Client     Has id                Boolean          Indicates if the next field is present.
...
#### Server Data {#server_data}
  ...
  Packet ID   State   Bound To   Field Name             Field Type                Notes
  ----------- ------- ---------- ---------------------- ------------------------- ------------------------
  0x42        Play    Client     Has MOTD               Boolean                   
                                 MOTD                   Optional Chat             
                                 Has Icon               Boolean                   
...
#### Set Action Bar Text {#set_action_bar_text}
  ...
  Packet ID   State   Bound To   Field Name        Field Type                Notes
  ----------- ------- ---------- ----------------- ------------------------- ------------------------------------------------------------------------------------------------------------------------
  0x43        Play    Client     Action bar text   [Chat](Chat "wikilink")   Displays a message above the hotbar (the same as position 2 in [Player Chat Message](#Player_Chat_Message "wikilink").

#### Set Border Center {#set_border_center}

  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ -------
  0x44        Play    Client     X            Double       
                                 Z            Double       
...
#### Set Border Lerp Size {#set_border_lerp_size}
  ...
  Packet ID   State   Bound To   Field Name     Field Type   Notes
  ----------- ------- ---------- -------------- ------------ ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  0x45        Play    Client     Old Diameter   Double       Current length of a single side of the world border, in meters.
                                 New Diameter   Double       Target length of a single side of the world border, in meters.
                                 Speed          VarLong      Number of real-time *milli*seconds until New Diameter is reached. It appears that Notchian server does not sync world border speed to game ticks, so it gets out of sync with server lag. If the world border is not moving, this is set to 0.
...
#### Set Border Size {#set_border_size}
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ ---------------------------------------------------------
  0x46        Play    Client     Diameter     Double       Length of a single side of the world border, in meters.

#### Set Border Warning Delay {#set_border_warning_delay}

  Packet ID   State   Bound To   Field Name     Field Type   Notes
  ----------- ------- ---------- -------------- ------------ ---------------------------------------------------
  0x47        Play    Client     Warning Time   VarInt       In seconds as set by `/worldborder warning time`.

#### Set Border Warning Distance {#set_border_warning_distance}

  Packet ID   State   Bound To   Field Name       Field Type   Notes
  ----------- ------- ---------- ---------------- ------------ ------------
  0x48        Play    Client     Warning Blocks   VarInt       In meters.
...
spectating an entity).
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ --------------------------------------------------
  0x49        Play    Client     Camera ID    VarInt       ID of the entity to set the client\'s camera to.
...
#### Set Held Item (clientbound) {#set_held_item_clientbound}

Sent to change the player\'s slot selection.

  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ ------------------------------------------------
  0x4A        Play    Client     Slot         Byte         The slot which the player has selected (0--8).
...
even if it doesn\'t go across a chunk section border.
  ...
  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ -----------------------------------------------
  0x4B        Play    Client     Chunk X      VarInt       Chunk X coordinate of the player\'s position.
...
the overworld after leaving the end.
  ...
  Packet ID   State   Bound To   Field Name      Field Type   Notes
  ----------- ------- ---------- --------------- ------------ -------------------------
  0x4C        Play    Client     View Distance   VarInt       Render distance (2-32).
...
#### Set Display Chat Preview {#set_display_chat_preview}

Sets if chat preview is enabled or disabled on the server. Not used by
the server.

  Packet ID   State   Bound To   Field Name             Field Type   Notes
  ----------- ------- ---------- ---------------------- ------------ -------
  0x4E        Play    Client     Chat Preview Setting   Boolean      
...
This is sent to the client when it should display a scoreboard.
  ...
  Packet ID   State   Bound To   Field Name   Field Type    Notes
  ----------- ------- ---------- ------------ ------------- -------------------------------------------------------------------------------------------------------------------------------
  0x4F        Play    Client     Position     Byte          The position of the scoreboard. 0: list, 1: sidebar, 2: below name, 3 - 18: team specific sidebar, indexed as 3 + team color.
...
`{{Minecraft Wiki|Lead|leashed}}`{=mediawiki} to another entity.
  ...
  Packet ID   State   Bound To   Field Name           Field Type   Notes
  ----------- ------- ---------- -------------------- ------------ ---------------------------------------------------------
  0x51        Play    Client     Attached Entity ID   Int          Attached entity\'s EID.
...
Sent by the server when the client should change experience levels.
  ...
  Packet ID   State   Bound To   Field Name         Field Type   Notes
  ----------- ------- ---------- ------------------ ------------ -----------------------------------------------------------------------------------------------------------------------------
  0x54        Play    Client     Experience bar     Float        Between 0 and 1.
                                 Level              VarInt       
...
food bar.
  ...
  Packet ID   State   Bound To   Field Name        Field Type   Notes
  ----------- ------- ---------- ----------------- ------------ ------------------------------------------------------
  0x55        Play    Client     Health            Float        0 or less = dead, 20 = full HP.
                                 Food              VarInt       0--20.
...
`{{Minecraft Wiki|scoreboard}}`{=mediawiki} objective or remove one.
  ...
  Packet ID   State   Bound To   Field Name        Field Type             Notes
  ----------- ------- ---------- ----------------- ---------------------- ---------------------------------------------------------------------------------------
  0x56        Play    Client     Objective Name    String (16)            A unique name for the objective.
...
#### Set Passengers {#set_passengers}
  ...
  Packet ID   State   Bound To   Field Name        Field Type        Notes
  ----------- ------- ---------- ----------------- ----------------- --------------------------------------------
  0x57        Play    Client     Entity ID         VarInt            Vehicle\'s EID.
...
Creates and updates teams.
  ...
  Packet ID   State   Bound To   Field Name                                           Field Type
  ----------- ------- ---------- ------------------------------ --------------------- ----------------------
  0x58        Play    Client     Team Name                                            String (16)
                                 Mode                                                 Byte
...
This is sent to the client when it should update a scoreboard item.
  ...
  Packet ID   State   Bound To   Field Name       Field Type        Notes
  ----------- ------- ---------- ---------------- ----------------- ------------------------------------------------------------------------------------------------------------
  0x59        Play    Client     Entity Name      String (40)       The entity whose score this is. For players, this is their username; for other entities, it is their UUID.
...
#### Set Simulation Distance {#set_simulation_distance}
  ...
  Packet ID   State   Bound To   Field Name            Field Type   Notes
  ----------- ------- ---------- --------------------- ------------ ------------------------------------------------------------------------------
  0x5A        Play    Client     Simulation Distance   VarInt       The distance that the client will process specific things, such as entities.

#### Set Subtitle Text {#set_subtitle_text}

  Packet ID   State   Bound To   Field Name      Field Type                Notes
  ----------- ------- ---------- --------------- ------------------------- -------
  0x5B        Play    Client     Subtitle Text   [Chat](Chat "wikilink")   
...
The default SMP server increments the time by `20` every second.
  ...
  Packet ID   State   Bound To   Field Name    Field Type   Notes
  ----------- ------- ---------- ------------- ------------ ---------------------------------------------------------------------------------------------------------
  0x5C        Play    Client     World Age     Long         In ticks; not changed by server commands.
...
#### Set Title Text {#set_title_text}
  ...
  Packet ID   State   Bound To   Field Name   Field Type                Notes
  ----------- ------- ---------- ------------ ------------------------- -------
  0x5D        Play    Client     Title Text   [Chat](Chat "wikilink")   

#### Set Title Animation Times {#set_title_animation_times}

  Packet ID   State   Bound To   Field Name   Field Type   Notes
  ----------- ------- ---------- ------------ ------------ ----------------------------------------------------------
  0x5E        Play    Client     Fade In      Int          Ticks to spend fading in.
...
Plays a sound effect from an entity.
  ...
  Packet ID   State   Bound To   Field Name       Field Type    Notes
  ----------- ------- ---------- ---------------- ------------- --------------------------------------------------------------------------------------------------------------------------------
  0x5F        Play    Client     Sound ID         VarInt        ID of hardcoded sound event ([events](https://pokechu22.github.io/Burger/1.19.html#sounds)).
                                 Sound Category   VarInt Enum   The category that this sound will be played from ([current categories](https://gist.github.com/konwboj/7c0c380d3923443e9d55)).
                                 Entity ID        VarInt        
...
custom sounds, use [Custom Sound
Effect](#Custom_Sound_Effect "wikilink").
...
```
  Packet ID   State   Bound To   Field Name          Field Type    Notes
  ----------- ------- ---------- ------------------- ------------- -----------------------------------------------------------------------------------------------------------------------------------------------
  0x60        Play    Client     Sound ID            VarInt        ID of hardcoded sound event ([events](https://pokechu22.github.io/Burger/1.19.html#sounds)).
                                 Sound Category      VarInt Enum   The category that this sound will be played from ([current categories](https://gist.github.com/konwboj/7c0c380d3923443e9d55)).
                                 Effect Position X   Int           Effect X multiplied by 8 ([fixed-point number](Data_types#Fixed-point_numbers "wikilink") with only 3 bits dedicated to the fractional part).
                                 Effect Position Y   Int           Effect Y multiplied by 8 ([fixed-point number](Data_types#Fixed-point_numbers "wikilink") with only 3 bits dedicated to the fractional part).
                                 Effect Position Z   Int           Effect Z multiplied by 8 ([fixed-point number](Data_types#Fixed-point_numbers "wikilink") with only 3 bits dedicated to the fractional part).
...
#### Stop Sound {#stop_sound}
  ...
  Packet ID   State   Bound To   Field Name   Field Type             Notes
  ----------- ------- ---------- ------------ ---------------------- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
  0x61        Play    Client     Flags        Byte                   Controls which fields are present.
...
positions.
  ...
  Packet ID   State   Bound To   Field Name   Field Type                Notes
  ----------- ------- ---------- ------------ ------------------------- ------------------------------------------------------
  0x62        Play    Client     JSON Data    [Chat](Chat "wikilink")   Limited to 262144 bytes.
...
Notchian server.
  ...
  Packet ID   State   Bound To   Field Name   Field Type                Notes
  ----------- ------- ---------- ------------ ------------------------- -------------------------------------------------------------------
  0x63        Play    Client     Header       [Chat](Chat "wikilink")   To remove the header, send a empty text component: `{"text":""}`.
...
Tag](#Query_Entity_Tag "wikilink").
  ...
  Packet ID   State   Bound To   Field Name       Field Type                  Notes
  ----------- ------- ---------- ---------------- --------------------------- ---------------------------------------------------------------------------------------
  0x64        Play    Client     Transaction ID   VarInt                      Can be compared to the one sent in the original query packet.
...
different varieties of arrows.
  ...
  Packet ID   State   Bound To   Field Name            Field Type   Notes
  ----------- ------- ---------- --------------------- ------------ ------------------------------------------------------------------------
  0x65        Play    Client     Collected Entity ID   VarInt       
...
#### Update Advancements {#update_advancements}
  ...
  Packet ID   State   Bound To   Field Name                    Field Type
  ----------- ------- ---------- --------------------- ------- ---------------------
  0x67        Play    Client     Reset/Clear                   Boolean
                                 Mapping size                  VarInt
...
#### Entity Effect {#entity_effect}
  ...
  Packet ID   State   Bound To   Field Name        Field Type   Notes
  ----------- ------- ---------- ----------------- ------------ ---------------------------------------------------------------------------
  0x69        Play    Client     Entity ID         VarInt       
                                 Effect ID         VarInt       See `{{Minecraft Wiki|Status effect#Effect IDs|this table}}`{=mediawiki}.
...
#### Update Recipes {#update_recipes}
  ...
  Packet ID   State   Bound To   Field Name                Field Type
  ----------- ------- ---------- ------------- ----------- ------------
  0x6A        Play    Client     Num Recipes               VarInt
                                 Recipe        Type        Array
                                               Recipe ID   
                                               Data        
...
#### Update Tags {#update_tags}
  ...
  Packet ID   State   Bound To   Field Name                           Field Type
  ----------- ------- ---------- --------------------- -------------- ------------
  0x6B        Play    Client     Length of the array                  VarInt
...
#### Message Acknowledgment {#message_acknowledgment}
  ...
  Packet ID   State   Bound To   Field Name              Field Type   Notes
  ----------- ------- ---------- ----------------------- ------------ ---------------------------------------------------
  0x03        Play    Server     Has Data                Boolean      If true, all of the following fields are present.
                                 Profile ID              UUID         
                                 Last Signature Length   VarInt       Length of the following array.
                                 Last Signature          Byte Array   
...
chat](Chat#Processing_chat "wikilink") for more information.
  ...
  0x05        Play    Server     Message                                                 String (256 chars)
                                 ...
                                 Signed Preview                                          Boolean
                                 Array length                                            VarInt
                                 Array of previously seen messages   User                UUID
                                                                     Message signature   Byte Array
                                 Has last message                                        Boolean
                                 Last message                        User                Optional UUID
                                                                     Message signature   Optional Byte Array

#### Chat Preview (serverbound) {#chat_preview_serverbound}

  Packet ID   State   Bound To   Field Name   Field Type     Notes
  ----------- ------- ---------- ------------ -------------- -------
  0x06        Play    Server     Query        Integer        
                                 Message      String (256)   
...
#### Close Container (serverbound) {#close_container_serverbound}
...
#### Move Vehicle (serverbound) {#move_vehicle_serverbound}
...
-   [Set Held Item](#Set_Held_Item_(clientbound) "wikilink"), with the
    slot set to the newly chosen slot.
...
#### Resource Pack (serverbound) {#resource_pack_serverbound}
...
#### Set Held Item (serverbound) {#set_held_item_serverbound}
