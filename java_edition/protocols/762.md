...
[here](https://pokechu22.github.io/Burger/1.19.4.html#sounds).
...
-   minecraft:bundle - enables support for the bundle
    ...
    ```
-   minecraft:update_1_20 - enables all the Minecraft 1.20 features that
    are available in 1.19.4
    ```{=html}
    </li>
    ```
...
|                      | `                    |                      |
|                      | {{Warning|The Notchi |                      |
|                      | an server only sends |                      |
|                      |  this recipe if [[Pr |                      |
|                      | otocol#Feature_Flags |                      |
|                      | |feature flag]] '''u |                      |
|                      | pdate_1_20''' was en |                      |
|                      | abled}}`{=mediawiki} |                      |
+----------------------+----------------------+----------------------+
...
|                      |                      | (Slot "wikilink")    |
+----------------------+----------------------+----------------------+
| `minecraft:smithing` | Smithing table       | As follows:          |
|                      | recipe               |                      |
|                      | `{{Warning|          |   Name               |
|                      | The Notchian server  |    Type              |
|                      | only sends this reci |          Description |
|                      | pe if [[Protocol#Fea |   ----------         |
|                      | ture_Flags|feature f | -------------------- |
|                      | lag]] '''update_1_20 | ----- -------------- |
|                      | ''' was '''not''' en |   Base               |
|                      | abled}}`{=mediawiki} |    Ingredient        |
|                      |                      |          First item. |
|                      |                      |   Addition           |
|                      |                      |   Ingredient         |
|                      |                      |         Second item. |
...
|                      | `{{Wa                |   Name               |
|                      | rning2|The Notchian  |    Type              |
|                      | server only sends th |          Description |
|                      | is recipe if [[Proto |   -----              |
|                      | col#Feature_Flags|fe | ----- -------------- |
|                      | ature flag]] '''upda | ----------- -------- |
|                      | te_1_20''' was enabl | -------------------- |
|                      | ed. It supersedes th |                      |
|                      | e <code>minecraft:sm |  Template   Ingredie |
|                      | ithing</code> recipe | nt                Th |
|                      |  type}}`{=mediawiki} | e smithing template. |
|                      |                      |   Base               |
|                      |                      | Ingredient           |
|                      |                      |       The base item. |
|                      |                      |   Add                |
...
|                      | `{{Wa                |   Name       Type    |
|                      | rning2|The Notchian  |          Description |
|                      | server only sends th |   ---------- -       |
|                      | is recipe if [[Proto | ----------- -------- |
|                      | col#Feature_Flags|fe | -------------------- |
|                      | ature flag]] '''upda |   Templa             |
|                      | te_1_20''' was enabl | te   Ingredient   Th |
|                      | ed. It supersedes th | e smithing template. |
|                      | e <code>minecraft:sm |   Base       Ingredi |
|                      | ithing</code> recipe | ent   The base item. |
|                      |  type}}`{=mediawiki} |   Addition           |
|                      |                      |  Ingredient   The ad |
|                      |                      | ditional ingredient. |
+----------------------+----------------------+----------------------+
